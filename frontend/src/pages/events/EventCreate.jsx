    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.card}>
                <h1 style={styles.title}>Tambah Event Baru</h1>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={styles.row}>
                        <div style={{ ...styles.field, flex: 1 }}>
                            <label style={styles.label}>
                                Organizer {organizers.length === 0 && <span style={styles.hint}>(belum ada data)</span>}
                            </label>
                        ...
                        <div style={{ ...styles.field, flex: 1 }}>
                            <label style={styles.label}>
                                Venue {venues.length === 0 && <span style={styles.hint}>(belum ada data)</span>}
                            </label>
                    ...
                    <div style={styles.btnRow}>
                        <Link to="/events" style={styles.btnCancel}>Batal</Link>
...
const styles = {
    ...
    hint: { color: '#ef4444', fontSize: '12px', marginLeft: '6px' },
